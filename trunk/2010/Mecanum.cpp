...
static const unsigned int kB_Mecanum                      = kJOY_Button9;
static const unsigned int kB_Arcade                       = kJOY_Button10;
...
*/
        ...
        const bool bPressed_Mecanum= m_joyButtonState.GetState(kB_Mecanum);
       	        if (bPressed_Mecanum)
       	        {
       	         m_coef_X_FR = -1.000000;
       	         m_coef_Y_FR = -1.000000;
       	 ...
       	 const bool bPressed_Arcade= m_joyButtonState.GetState(kB_Arcade);
       	       if (bPressed_Arcade)
       	       {
       	         m_coef_X_FR = 1.000000;
       	         m_coef_Y_FR = -1.000000;
       	         m_coef_Z_FR = 0.000000;
       	         m_coef_X_FL = -1.000000;
       	         m_coef_Y_FL = -1.000000;
       	         m_coef_Z_FL = 0.000000;
       	         m_coef_X_RR = 1.000000;
       	         m_coef_Y_RR = -1.000000;
       	         m_coef_Z_RR = 0.000000;
       	         m_coef_X_RL = -1.000000;
       	         m_coef_Y_RL = -1.000000;
       	         m_coef_Z_RL = 0.000000;
       	       }
}
...
{
	 const bool bPressed_kFQB_T1= m_joyButtonState.GetState( kFQB_T1 );
	        if (bPressed_kFQB_T1)
	        { 
	        	 m_pBallMagnet->Set(0);
	        }
	       
	        const bool bPressed_kFQB_T2 = m_joyButtonState.GetState( kFQB_T1 );
	        if (bPressed_kFQB_T2)
	        { 
...
void PrototypeController::ProcessTower()
{
        ...
        if (bPressed_kFQB_T1)
        { 
        	 m_pTowerSolenoid->Set(0);
        }
       
        const bool bPressed_kFQB_T2 = m_joyButtonState.GetState( kFQB_T1 );
        if (bPressed_kFQB_T2)
        { 
            m_pTowerSolenoid->Set(m_pFlightQuadrant->GetY() < 0.0f);
        }
